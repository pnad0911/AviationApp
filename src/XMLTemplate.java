 ...
 * @author Duy Pham
 * @see <br><a target="_blank"href="http://java.sun.com/xml/jaxp/dist/1.1/docs/tutorial/TOC.html">Document Builder Factory</a>
 * @see <br><a target="_blank"href="http://java.sun.com/j2se/1.4.2/docs/api/javax/xml/parsers/DocumentBuilder.html">Document Builder</a>
 * @see <br><a target="_blank"href="http://java.sun.com/j2se/1.4.2/docs/api/org/w3c/dom/Document.html">Document</a>
 * @see <br><a target="_blank"href="http://java.sun.com/j2se/1.4.2/docs/api/org/w3c/dom/NodeList.html">Document NodeList</a>
 * @see <br><a target="_blank"href="http://java.sun.com/j2se/1.5.0/docs/api/index.html">Java 1.5 Documentation by Sun Corporation</a>
